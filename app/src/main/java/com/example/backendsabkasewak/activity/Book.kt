...
import com.example.backendsabkasewak.databinding.ActivityBookBinding
                ...
                if (::imageUri.isInitialized && imageUri != Uri.EMPTY) {
                    ...
                    imageStorageReference.putFile(imageUri)
                        ...
                        .addOnFailureListener {
                            // Handle the error
                            Toast.makeText(this@Book, "Image Upload Failed", Toast.LENGTH_SHORT).show()
                ...
                entryKey?.let {
                    if (pdfUri.isNotEmpty()) {
                        ...
                        pdfStorageReference.putFile(Uri.parse(pdfUri))
                            .addOnSuccessListener { pdfTaskSnapshot ->
                                ...
                                pdfStorageReference.downloadUrl.addOnSuccessListener { pdfDownloadUri ->
                                    ...
                                    database.child(entryKey).setValue(noticeItem)
                                        ...
                                        .addOnFailureListener {
                                            Toast.makeText(this@Book, "Data Upload Failed", Toast.LENGTH_SHORT).show()
                                            progressDialog.dismiss()
                                        }
                                }
                            }
                            .addOnFailureListener {
                                // Handle the error
                                Toast.makeText(this@Book, "PDF Upload Failed", Toast.LENGTH_SHORT).show()
                                progressDialog.dismiss()
                            }
                    } else {
