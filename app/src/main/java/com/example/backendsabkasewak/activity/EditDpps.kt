...
class EditDpps : AppCompatActivity() {
    private lateinit var binding:ActivityEditDppsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEditDppsBinding.inflate(layoutInflater)
        setContentView(binding.root)

                db = FirebaseDatabase.getInstance().reference.child("Dpp")
                arrayList = arrayListOf()

                noticeAdapter = NoticeAdapterN(arrayList, this@EditDpps)
