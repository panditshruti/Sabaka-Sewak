...
import com.example.backendsabkasewak.databinding.ActivityEditDppsBinding
import com.example.backendsabkasewak.databinding.ActivityEditStanzaBinding
...
class EditStanza : AppCompatActivity() {
    private lateinit var binding:ActivityEditStanzaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEditStanzaBinding.inflate(layoutInflater)
        setContentView(binding.root)

                db = FirebaseDatabase.getInstance().reference.child("Stanza")
                arrayList = arrayListOf()

                noticeAdapter = NoticeAdapterN(arrayList, this@EditStanza)
