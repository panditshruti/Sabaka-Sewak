        ...
        if (::imageUri.isInitialized && imageUri != Uri.EMPTY) {
            ...
            imageStorageReference.putFile(imageUri)
                ...
                .addOnFailureListener {
                    // Handle the error
                    Toast.makeText(this@News, "Image Upload Failed", Toast.LENGTH_SHORT).show()
                        ...
                        pdfStorageReference.downloadUrl.addOnSuccessListener { pdfDownloadUri ->
                            ...
                            database.child(entryKey).setValue(noticeItem)
                                .addOnSuccessListener {
                                    Toast.makeText(this@News, "Data Uploaded Successfully", Toast.LENGTH_SHORT).show()
...
//                                    binding.pdfchoose.tag = null
                                ...
                                .addOnFailureListener {
                                    Toast.makeText(this@News, "Data Upload Failed", Toast.LENGTH_SHORT).show()
                                    progressDialog.dismiss()
                                }
                        }
                    }
                    .addOnFailureListener {
                        // Handle the error
                        Toast.makeText(this@News, "PDF Upload Failed", Toast.LENGTH_SHORT).show()
                        progressDialog.dismiss()
                    }
            } else {
