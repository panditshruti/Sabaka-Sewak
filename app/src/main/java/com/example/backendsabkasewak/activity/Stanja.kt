...
import com.example.backendsabkasewak.databinding.ActivityStanjaBinding
...
class Stanja : AppCompatActivity() {
    private lateinit var binding:ActivityStanjaBinding
    private lateinit var database: DatabaseReference
    private lateinit var imageUri: Uri
    private lateinit var pdfUri: Uri
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityStanjaBinding.inflate(layoutInflater)
        setContentView(binding.root)
                ...
                binding.editstanja.setOnClickListener {
                    val intent = Intent(this, EditStanza::class.java)
                ...
                if (::imageUri.isInitialized && imageUri != Uri.EMPTY) {
                    ...
                    imageStorageReference.putFile(imageUri)
                        ...
                        .addOnFailureListener {
                            // Handle the error
                            Toast.makeText(this@Stanja, "Image Upload Failed", Toast.LENGTH_SHORT).show()
                ...
                entryKey?.let {
                    if (pdfUri.isNotEmpty()) {
                        ...
                        pdfStorageReference.putFile(Uri.parse(pdfUri))
                                ...
                                pdfStorageReference.downloadUrl.addOnSuccessListener { pdfDownloadUri ->
                                    ...
                                    database.child(entryKey).setValue(noticeItem)
                                        .addOnSuccessListener {
                                            Toast.makeText(this@Stanja, "Data Uploaded Successfully", Toast.LENGTH_SHORT).show()
                                        ...
                                        .addOnFailureListener {
                                            Toast.makeText(this@Stanja, "Data Upload Failed", Toast.LENGTH_SHORT).show()
                                            progressDialog.dismiss()
                                        }
                                }
                            }
                            .addOnFailureListener {
                                // Handle the error
                                Toast.makeText(this@Stanja, "PDF Upload Failed", Toast.LENGTH_SHORT).show()
                                progressDialog.dismiss()
                            }
                    } else {
