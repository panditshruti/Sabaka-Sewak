...
class VacancyNotice : AppCompatActivity() {
    private lateinit var binding: ActivityVacancyNoticeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityVacancyNoticeBinding.inflate(layoutInflater)
        setContentView(binding.root)

        database = FirebaseDatabase.getInstance().getReference().child("Vaccancy Notice")
